...
function MeshModel(props: MeshyModelShapeBodyProps) {
...
function MeshScene(props: MeshyModelShapeBodyProps) {
  return (
    <>
      ...
      <Bounds fit clip margin={1.02}>
        <Center>
          <MeshModel assetUrl={props.assetUrl} yRotation={props.yRotation} />
        </Center>
      </Bounds>
    </>
  );
    ...
    <div className="meshy-model-shape__canvas-wrap">
      ...
      >
        <Suspense fallback={null}>
          <MeshScene assetUrl={props.assetUrl} yRotation={props.yRotation} />
        </Suspense>
      </Canvas>
    </div>
  );
